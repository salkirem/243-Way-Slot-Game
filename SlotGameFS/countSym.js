...
// Load symbols data
const symbolsData = loadJson("FreeSpinReelSymbols");
const symbols = symbolsData.FreeSpinSym;

// Load reel set data
const reelSetData = loadJson("FreeSpinGameReelSet");
const reels = reelSetData.FreeSpinReels;
